...
If your phone falls in the bath at 4 months, you should not lose the four months of data you logged. That is not a paid feature. That is a basic safety net.
...
- [ ] No ads
- [ ] No paid-tier badges over core tracking features in the screenshots
...
- Smart reminders and iPhone Live Activities.
...
Nubo Plus exists, and it adds advanced tools: advanced growth metrics, Alexa voice logging, the Midnight Ember night theme, CSV export, Sleep Sounds, Care Vault, and private pumping tools. It is $39.99 a year, and it is optional. None of the free-tier features above ever paywall.
