...
The Pumping tool is available with Nubo Plus. If your subscription ends, you will not be able to log new sessions. Your existing data is not deleted. It stays in local storage on your phone and in your private CloudKit backup. Export remains available. The data is yours regardless of your subscription status.
